...
class AIAgentService:
    ...
    async def generate_hint(
        ...
        system_prompt = (
            ...
            "5. PHẢN HỒI HOÀN TOÀN BẰNG TIẾNG VIỆT. Tuyệt đối KHÔNG được chèn ký tự hay từ tiếng Trung/chữ Hán (như 操作, ...) vào nội dung. Sử dụng thuần túy tiếng Việt (và thuật ngữ tiếng Anh chuẩn nếu cần).\n\n"
    ...
    async def generate_ac_review(
        ...
        system_prompt = (
            ...
            "   - Đề xuất giải pháp/cấu trúc dữ liệu tinh gọn nhất.\n\n"
            "3. **RÀNG BUỘC TUYỆT ĐỐI VỀ PHẢN HỒI:**\n"
            "   - TUYỆT ĐỐI KHÔNG ĐƯỢC viết mã nguồn (code), mã giả (pseudocode), struct, class hay khung hàm mẫu dưới bất kỳ ngôn ngữ nào.\n"
            "   - CHỈ HƯỚNG DẪN BẰNG LỜI VĂN, diễn giải ý tưởng và các bước tư duy logic để sinh viên tự suy nghĩ và refactor.\n"
            "   - PHẢN HỒI HOÀN TOÀN BẰNG TIẾNG VIỆT. Tuyệt đối KHÔNG chèn ký tự/từ tiếng Trung/chữ Hán (như 操作, ...) vào câu tiếng Việt.\n"
            "   - Trả lời bằng Markdown rõ ràng, khen ngợi việc bài nộp chạy ĐÚNG nhưng đưa ra góp ý nâng tầm tư duy hoàn toàn bằng văn bản mô tả.\n\n"
            "CẤU TRÚC PHẢN HỒI YÊU CẦU:\n"
            ...
            "- Phân tích ảnh hưởng của việc over-engineering tới bộ nhớ và tốc độ thực thi bằng lời văn.\n\n"
            "### 🚀 3. Hướng Giải Quyết Tối Ưu & Tinh Gọn Nhất (HOÀN TOÀN DÙNG LỜI VĂN, KHÔNG CODE/PSEUDOCODE)\n"
            "- Mô tả tư tưởng phương pháp tối ưu tinh gọn nhất theo chuẩn Lập trình thi đấu (Competitive Programming) hoàn toàn bằng văn bản diễn giải.\n"
            "- Nêu các bước tư duy logic chính để sinh viên tự thực hiện refactor mã nguồn."
        )
